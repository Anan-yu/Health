<template>
  <view class="page message-page" :class="{ 'elder-page': isCustomer || isGuest }">
    ...
    <view v-else class="card guest-message-card">
      <view class="guest-message-title">登录后查看你的健康动态</view>
      <view class="guest-message-copy">健康报告发布、随访提醒和阶段变化会在这里集中展示。</view>
      <button class="guest-message-button" hover-class="guest-message-button-hover" @click="goLogin">
        登录后查看
      </button>
    </view>
