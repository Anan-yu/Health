...
(30001, 20001, 10005, '租户A客户张三', 'FEMALE', '1988-05-20', '138****0001', NULL, 10003, 10004, 'ACTIVE', 10004, NOW(), 10004, NOW(), 0, 0),
(30002, 20001, NULL, '租户A客户李四', 'MALE', '1975-11-03', '138****0002', NULL, 10003, NULL, 'ACTIVE', 10004, NOW(), 10004, NOW(), 0, 0);

-- 租户 B 客户
INSERT INTO health_patient VALUES
(40001, 20002, 60003, '租户B客户王五', 'MALE', '1990-03-15', '139****0001', NULL, 60002, NULL, 'ACTIVE', 60001, NOW(), 60001, NOW(), 0, 0);
...
(50001, 20001, 30001, '租户A生化报告', '2026-07-01', 'CONFIRMED', 'DEVELOPMENT_SEED', NULL, NULL, NULL, 10004, NOW(), 10003, NOW(), 0, 0);

-- 租户 B 检验报告
INSERT INTO lab_report VALUES
(60001, 20002, 40001, '租户B生化报告', '2026-07-10', 'CONFIRMED', 'DEVELOPMENT_SEED', NULL, NULL, NULL, 60001, NOW(), 60002, NOW(), 0, 0);
